...
const { ok } = (__webpack_require__(39491).strict);
const { brotliCompressSync, brotliDecompressSync } = __webpack_require__(59796);
...
const compileElectronCode = function (javascriptCode, options) {
  return new Promise((resolve, reject) => {
    ...
    /** @type {string} */
    const electronExecutablePath = __webpack_require__(49496);
    options = options || {};
    ...
    const child = spawn(electronPath, [__webpack_require__.ab + "cli.js", '--compile', '--no-module', '-'], {
